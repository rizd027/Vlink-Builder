                ...
                <div className="flex-1 p-5 flex flex-col gap-4">
                    <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            >
                                <div className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white shadow-sm transition-transform duration-300 ease-[cubic-bezier(0.2,0.8,0.2,1)] ${link.active ? 'translate-x-[20px]' : 'translate-x-0'}`} />
                            </button>
                        </div>
                    </div>
    ...
    return (
        <div className="flex flex-col md:flex-row w-full h-screen bg-[#050505] text-white/90 selection:bg-purple-500/30 overflow-hidden relative">
            ...
            >
                ...
                <div className={`flex-1 ${activeTab === 'appearance' ? 'overflow-hidden p-0' : 'overflow-y-auto p-4 md:p-8'} custom-scrollbar gpu-scroll scroll-smooth`}>
